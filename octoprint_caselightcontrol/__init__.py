...
class CaseLightControlPlugin(octoprint.plugin.SettingsPlugin,
    ...
    def get_assets(self):
        ...
        # core UI here.
        return {
            "js": ["js/caselightcontrol.js"],
            "css": ["css/caselightcontrol.css"],
            "less": ["less/caselightcontrol.less"]
        }
    ...
    def get_update_information(self):
        ...
        return {
            "caselightcontrol": {
                ...
                "type": "github_release",
                "user": "bgpat",
                "repo": "OctoPrint-CaseLightControl",
                "current": self._plugin_version,

                # update method: pip
                "pip": "https://github.com/bgpat/OctoPrint-CaseLightControl/archive/{target_version}.zip",
            }
        }
